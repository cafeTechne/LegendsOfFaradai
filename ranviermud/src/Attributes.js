...
class Attributes extends Map
{
  ...
  constructor(baseStats) {
    ...
    baseStats =  { //baseStats ||
      ...
      Armor: { base: 0 },
      Agility: { base:  50},
      Kinesthetic_IQ: { base:  50 },
      Crystallized_IQ: { base:  50 }, 
      Fluid_IQ: { base:  50 },
      Spatiality: { base:  50 },
      Musicality: { base:  50 },
      Logicality: { base:  50 },
      Sociality: { base:  50 },
      Intrapersonality: { base:  50 },
      Street_Wisdom: { base:  50 },
      Moral_Intelligence: { base:  50 },
      Anaerobic_Strength: { base:  50 },
      Aerobic_Strength: { base:  50 },
      Explosive_Strength: { base:  50 },
      Physical_Endurance: { base:  50 },
      Social_Endurance: { base:  50 },
      Mental_Endurance: { base:  50 },
      Determination: { base:  50 },
      Sensation_Seeking: { base:  50 },
      Sense_Probability: { base:  50 },
      Self_Confidence: { base:  50 },
      Impulsivity: { base:  50 },
      Neuroticism: { base:  50 },
      Empathy: { base:  50 },
      Sociopathy: { base:  50 },
      Open_Mindedness: { base:  50 },
      Conscientiousness: { base:  50 },
      Extraversion: { base:  50 },
      Agreeableness: { base:  50 },
      Critical: { base:  0 }
    };
